//FOUR022X JOB 'CICS DB2',MSGCLASS=X,CLASS=C,NOTIFY=&SYSUID             00010003
//*-------------------------------------------------------------------* 00020000
...
//COMPCIDB EXEC DFHCIDB2,NAME=F22CIP1,INSTR=FOUR022                     00060008
//BIND.SYSTSIN  DD *                                                    00080000
DSN  SYSTEM(DB8G)
BIND PLAN(F22CIP1) MEM(F22CIP1) ACT(REP) ISOLATION(CS) -                00090004
       LIB('DSN810.DBRMLIB.DATA')                                       00100000
BIND PACKAGE(FOUR022) MEM(F22CIP1) ACT(REP) ISOLATION(CS) -             00090004
